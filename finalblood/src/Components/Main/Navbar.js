                    ...
                    <div className="flex items-center justify-between">
                        <>
                            ...
                            {props.logIn ? (
                                ...
                                <>
                                    <DropDown title="Looking For Blood" children={[" Login/Register"]} links={["/register/"]}></DropDown>
                                    <DropDown title="Want To Donate Blood" children={["Donor Login/Register", "Blood Donation Events", "About Blood Donation"]} links={["/register/donor", "/bloodEvents", "/aboutBloodDonation"]}></DropDown>
                                    <DropDown title=" Login" children={["Login"]} links={["/login", "/register"]}></DropDown>
                                </>
                            )}
                            <button
