...
const Events = () => {
    ...
    useEffect(() => {
        axios.get(`/events/allevents/${data.states[state].state}/${data.states[state].districts[district]}/${date}`).then((r) => setFiltered(r.data)).catch((e) => alert("Something went wrong"));
    }, [state, district, date])
        ...
        <div className='px-7'>
            ...
            <table className='w-full text-center'>
                <thead>
                    ...
                    <th className="p-3 text-md border border-silver rounded">Event Name</th>
