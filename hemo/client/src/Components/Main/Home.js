...
import donationFact from "../../assets/handicon.png"
...
const Home = () => {
    ...
    return (
        <div className="dark:text-white-900">
            <div className='grid grid-cols-2 place-items-center mt-20 px-0'>
             
                <div>
                    
                    
                <img draggable={false} src={bg1} width="200%" alt="" />
                   
                </div>
                   <div>
                    <img draggable={false} src={bg2} width="300%" alt="" />
                </div>
            </div>
            <h1 className='font-bold text-center text-blood my-4 text-lg underline'>Learn About Donation</h1>
            <div className='flex px-20'>
                <div>
                    <img src={donationFact} width="30%" alt="" />
